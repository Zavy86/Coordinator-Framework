 ...
 */
 ...
 // build profile form
 $form=new cForm("?mod=".MODULE."&scr=submit&act=own_password_update","POST",null,"own_password");
 ...
 $form->addControl("button",api_text("own_password-cancel"),"?mod=".MODULE."&scr=own_profile");
 // build grid object
 $grid=new cGrid();
 $grid->addRow();
