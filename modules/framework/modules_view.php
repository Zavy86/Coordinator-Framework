 ...
 */
 ...
 if(ACTION=="module_authorizations_group_add"){
  ...
  $authorizations_join_form=new cForm("?mod=".MODULE."&scr=submit&act=module_authorizations_group_add&module=".$module_obj->module,"POST",null,"modules_view-authorizations_modal");
