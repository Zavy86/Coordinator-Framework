 ...
 */
 ...
 $dashboard->addTile("?mod=".MODULE."&scr=settings_edit&tab=generals",api_text("settings_edit"),api_text("settings_edit-description"),(api_checkAuthorization("framework-settings_manage")),"1x1","fa-toggle-on");
