 ...
 */
 ...
 // check session
 if(!$session->validity && !(MODULE=="framework" && SCRIPT=="submit" && (ACTION=="session_login" || ACTION=="own_password_recovery"))){$_SESSION['coordinator_session_redirect']=$_GET;api_redirect("login.php");}
 ...
 api_load_required_modules_recursively($module->required_modules_array);
